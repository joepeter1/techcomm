...
public class SidebarServiceImpl implements SidebarService {
    ...
    private SideBarDTO noticeSideBar() {
        ...
        return new SideBarDTO()
                .setTitle("关于技术社区")
                // TODO 知识星球的
                .setImg("https://sky-thao.oss-cn-qingdao.aliyuncs.com/tc.png")
                .setItems(items)
    ...
    private SideBarDTO subscribeSideBar() {
        return new SideBarDTO().setTitle("订阅").setSubTitle("tttghao")
                .setImg("https://sky-thao.oss-cn-qingdao.aliyuncs.com/qrcode_for_gh_f277669bf66a_258.jpg")
                .setContent("10本武功秘籍")
