...
insert into dict_common(`type_code`,`dict_code`,`dict_desc`,`sort_no`) values('AISource','2','技术社区',3);
...
insert into dict_common(`type_code`,`dict_code`,`dict_desc`,`sort_no`) values('StarSource','1','技术社区知识星球',2);
...
insert into dict_common(`type_code`,`dict_code`,`dict_desc`,`sort_no`) values('UserAiStrategy','8','绑定技术社区知识星球',4);
