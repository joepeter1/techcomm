...
VALUES(1, 1, '管理员', 'https://sky-thao.oss-cn-qingdao.aliyuncs.com/%E6%8A%80%E6%9C%AF%E7%A4%BE%E5%8C%BA%E7%AE%A1%E7%90%86%E5%91%98%E5%A4%B4%E5%83%8F.jpg', 'java', 'xm', '码农', '', 0);
...
VALUES(1, 'tttghao的专栏', 1, '这里是tttghao的技术专栏，欢迎关注', 'https://sky-thao.oss-cn-qingdao.aliyuncs.com/tgzl2.jpeg', 1, '2022-09-15 01:00:00', '2022-09-15 01:00:00', '2022-09-15 01:00:00');
...
VALUES(100, 1, 1, '分布式系统的38个知识点', '38个知识点', '', '分布式系统的38个精选知识点', 1, 2, '', 1, 0, '2025-03-08 19:12:32', '2025-03-08 19:12:32');
INSERT INTO article
(id, user_id, article_type, title, short_title, picture, summary, category_id, source, source_url, status, deleted, create_time, update_time)
VALUES(101, 1, 1, '分布式系统的8个谬误', '8个经典谬误', '', '分布式系统常见的8个理解偏差', 1, 2, '', 1, 0, '2025-03-08 19:13:38', '2025-03-08 19:13:38');
INSERT INTO article
...
VALUES(102, 1, 1, '分布式系统的特征、瓶颈以及性能指标介绍', '分布式系统概要', '', '什么是分布式系统，特点是什么，问题又有哪些？', 1, 2, '', 1, 0, '2025-03-08 19:14:17', '2025-03-08 19:14:17', 1);

INSERT INTO article_tag
(article_id, tag_id, deleted, create_time, update_time)
VALUES(100, 1, 0, '2025-03-08 19:23:14', '2025-03-08 19:23:14');
INSERT INTO article_tag
(article_id, tag_id, deleted, create_time, update_time)
VALUES(101, 1, 0, '2025-03-08 19:23:35', '2025-03-08 19:23:35');
INSERT INTO article_tag
(article_id, tag_id, deleted, create_time, update_time)
VALUES(102, 1, 0, '2025-03-08 19:23:43', '2025-03-08 19:23:43');
...
拜占庭算法主要针对的是分布式场景下无响应，或者响应不可信的情况下的容错问题，其核心分三段流程
...
这是一篇概括性的综述类文章，可能并没有很多的干货，当然也限于我个人的能力，上面的总结可能并不准确，如有发现，请不吝赐教
...
', 0, '2025-03-08 19:12:32', '2025-03-08 19:23:14');
...
当系统分布在多个节点之上时，自然而然就带来了很多单机场景下不会有问题，如经典的——分布式系统的8个谬误
...
实际上分布式系统面临的挑战并不止于上面这些，一个具体的系统面临的问题可能各不相同，但总的来说，分布式系统的理论基础会给我们非常好的指引方向。
...
- 扩展性
- 一致性
', 0, '2022-10-08 19:14:17', '2022-10-08 19:23:43');
